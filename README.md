...
## Current Features:
 ...
 - Configs are backed up at app start. If you set Edit42 to use file mode, then the edit42-backup folder will be in your confs directory. If you selected API mode then the edit42-backup will be in the app directory
 - cool styling
